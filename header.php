...
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			<div class="container clearfix" style="margin:0 auto !important">
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<?php endif; ?>
                <a href="#">
                    <span id="et-info-fb"><i class="fab fa-facebook" style="font-size: 18px; color: #085982; margin-bottom: -2px;"></i></span>
                </a>
				<?php
